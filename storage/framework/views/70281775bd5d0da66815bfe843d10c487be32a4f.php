                    ...
                    <?php echo $__env->make('include.expert_sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        ...
                        <div class="row layout-top-spacing" style="margin-top:40px"> 
                            ...
                            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                                <a class="nav-link" href="<?php echo e(route('exptransaction.index',['type'=>'registration'])); ?>" >
                            ...
                            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                                <a class="nav-link" href="<?php echo e(route('exptransaction.index',['type'=>'appointment'])); ?>">
                                    <div class="widget widget-one_hybrid widget-followers" style="height: 95%;">
                                        <div class="widget-heading">
                            ...
                            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                                <a class="nav-link" href="<?php echo e(route('exptransaction.index',['type'=>'order'])); ?>">
                                    <div class="widget widget-one_hybrid widget-followers" style="height: 95%;">
                                        <div class="widget-heading">
                                            <p class="w-value"><i class="fas fa-exchange-alt"></i></p>
                                            <h5 class="">Orders</h5>
                                ...
                                <a class="nav-link" href="<?php echo e(route('exptransaction.index',['type'=>'booking'])); ?>">
                                    <div class="widget widget-one_hybrid widget-followers" style="height: 95%;">
                                        <div class="widget-heading">
                                            <p class="w-value"><i class="fas fa-exchange-alt"></i></p>
...
<?php echo $__env->make('include.script', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?> <?php /**PATH J:\xampp\htdocs\drolmaa\resources\views/expert_panel/transactions.blade.php ENDPATH**/ ?>