        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="back1">
                    ...
                    <form action="<?php echo e(route('expert.first.step.post')); ?>" method="POST" enctype='multipart/form-data'
                        class="formLogIn">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="row" style="margin-top:170px;">
                            <div class="col-md-4">
                                <div class="input-group mb-4">
                                    <input type="text" class="form-control" placeholder="Full Name" aria-label="Name"
                                        ...
                                        value="<?php echo e(old('full_name', !empty($expert) ? $expert->full_name : '')); ?>">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="input-group mb-4">
                                    <select class="form-control" id="exampleFormControlSelect1" name="user_gender">
                                        ...
                                        <option
                                            <?php echo e(old('user_gender', !empty($expert) ? $expert->user_gender : '') == $key ? 'selected' : ''); ?>

                                            value="<?php echo e($key); ?>"><?php echo e(ucfirst(strtolower($value))); ?></option>
                            ...
                            <div class="col-md-4">
                                <div class="input-group mb-4">
                                    <input type="number" placeholder="Age" class="form-control" name="user_age"
                                        value="<?php echo e(old('user_age', !empty($expert) ? $expert->user_age : '')); ?>">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="row">
                                    ...
                                    <div class="col-lg-9" style="padding-left:0px">  
                                        <div class="input-group mb-4">
                                            <input type="text" class="form-control" placeholder="Mobile Number"
                                                ...
                                                value="<?php echo e(old('mobile_number', !empty($expert) ? $expert->mobile_number : '')); ?>">
                                        </div>
                                    </div>
                                </div> 
                            </div>
                            <div class="col-md-4">
                                <div class="input-group mb-4">
                                    <input type="text" class="form-control" placeholder="Email Address"
                                        ...
                                        value="<?php echo e(old('email_address', !empty($expert) ? $expert->email_address : '')); ?>">
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="input-group mb-4">
                                    <select class="form-control" id="exampleFormControlSelect1"
                                        ...
                                        <option
                                            <?php echo e(old('country_id', !empty($expert) ? $expert->country_id : '') == $con_list->country_id ? 'selected' : ''); ?>

                                            value="<?php echo e($con_list->country_id); ?>"><?php echo e($con_list->country_name); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> -->
                                        <option <?php echo e(old('country_id','101', !empty($expert) ? $expert->country_id : '') == 101 ? 'selected' : ''); ?> value="101">India</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="input-group mb-4">
                                    <input type="hidden" name="state_id_hidden" id="state_id_hidden"
                                        value="<?php echo e(old('state_id', !empty($expert) ? $expert->state_id : '')); ?>">
                            ...
                            <div class="col-md-4">
                                <div class="input-group mb-4">
                                    <input type="hidden" name="city_id_hidden" id="city_id_hidden"
                                        value="<?php echo e(old('city_id', !empty($expert) ? $expert->city_id : '')); ?>">
                            ...
                            <div class="col-md-4">
                                <div class="input-group mb-4">
                                    <input type="text" class="form-control" placeholder="Home Address"
                                        ...
                                        value="<?php echo e(old('address_details',  !empty($expert) ? $expert->address_details : '')); ?>">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="input-group mb-4">
                                    <input type="password" class="form-control" placeholder="Password" aria-label="Password"
                                        aria-describedby="basic-addon1" name="user_password" value="<?php echo e(old('user_password')); ?>" id="user_password">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="password" class="form-control" placeholder="Confirm password"
                                        aria-label="Confirm password" aria-describedby="basic-addon1" name="confirm_password" value="<?php echo e(old('confirm_password')); ?>" id="confirm_password">
...
<script>
    ...
    </script><?php /**PATH J:\xampp\htdocs\drolmaa\resources\views/expert_panel/expert_register/step_first.blade.php ENDPATH**/ ?>