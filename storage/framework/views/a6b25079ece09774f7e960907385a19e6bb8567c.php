...
<section id="plan-every" class="plan-every" role="plan">
    <div class="container">
                ...
                <div class="row Plan-content active" id="Plan-content-1">
                    <div class="col-md-4">
                        <div class="plan-des">
                            ...
                            <div class="plan-box"
                                style="background-image:url(<?php echo e(asset('front_end/images/planimg1_1.png')); ?>);">
                            ...
                            <form action="<?php echo e(route('expert.fourth.step.post')); ?>" method="POST">
                                <?php echo csrf_field(); ?>
                                <script src="https://checkout.razorpay.com/v1/checkout.js"
                                    ...
                                    data-prefill.name="<?php echo e($expert->full_name); ?>"
                                    data-prefill.email="<?php echo e($expert->email_address); ?>" data-theme.color="#ff7529">
                                </script>
        ...
        <div class="mb-4 back-next">
            <a href="<?php echo e(route('expert.third.step')); ?>" class="back">Back</a>
        </div>
    </div>
</section>
...
</script><?php /**PATH J:\xampp\htdocs\drolmaa\resources\views/expert_panel/expert_register/step_fourth.blade.php ENDPATH**/ ?>