                                ...
                                <div class="mt-3">
                                    ...
                                    <div class="row layout-top-spacing" style="margin-top:40px"> 
                                        ...
                                        <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                                            <a href="<?php echo e(url('expert/profile')); ?>/<?php echo e(Session::get('user_id')); ?>/edit">
                                        ...
                                        <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                                            <a  href="<?php echo e(route('expert.transactions')); ?>">
                                                    <div class="widget widget-one_hybrid widget-followers" style="height: 95%;">
                                                    <div class="widget-heading">
                                        ...
                                        <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                                            <a href="<?php echo e(route('expappointment.index')); ?>">
                                                <div class="widget widget-one_hybrid widget-followers" style="height: 95%;">
                                                    <div class="widget-heading">
                                        ...
                                        <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                                            <a href="<?php echo e(route('expert.feedback')); ?>">
                                                <div class="widget widget-one_hybrid widget-followers" style="height: 95%;">
                                                    <div class="widget-heading">
                                    ...
                                    <div class="row layout-top-spacing" style="margin-top:40px">
                                        <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                                            <a href="<?php echo e(route('availabilty.index')); ?>">
                                                <div class="widget widget-one_hybrid widget-followers" style="height: 95%;">
                                                    <div class="widget-heading">
                                        ...
                                        <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                                            <a href="<?php echo e(route('workshopHome')); ?>">
                                                <div class="widget widget-one_hybrid widget-followers" style="height: 95%;">
                                                    <div class="widget-heading">
...
<?php echo $__env->make('include.script', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?> <?php /**PATH J:\xampp\htdocs\drolmaa\resources\views/expert_panel/dashboard.blade.php ENDPATH**/ ?>