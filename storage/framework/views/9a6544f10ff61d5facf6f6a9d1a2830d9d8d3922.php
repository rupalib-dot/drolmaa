            ...
            <div class="col-sm-12">
                ...
                <div class="row Plan-content active" id="Plan-content-1">
                    <div class="col-md-4">
                        <div class="plan-des"> 
                            <div class="plan-box"
                                style="background-image:url(<?php echo e(asset('front_end/images/planimg1.png')); ?>);">
                    ...
                    <div class="col-md-4">
                        <div class="plan-des">
                            <div class="plan-box"
                                style="background-image:url(<?php echo e(asset('front_end/images/planimg2.png')); ?>);">
...
<?php echo $__env->make('include.footer_bottom', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?> <?php /**PATH C:\xampp\htdocs\drolmaa\resources\views/pages/pricing.blade.php ENDPATH**/ ?>