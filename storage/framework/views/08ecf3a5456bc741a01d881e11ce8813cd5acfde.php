                                        ...
                                        <?php if(count($feedback_list['feedbackBy'])>0): ?>
                                            <?php $__currentLoopData = $feedback_list['feedbackBy']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feedbackBy): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="feedback-profile">
                                                    ...
                                                    <!-- if(!empty($feedbackBy->feedbackTo_users->user_image)){?>url(<?php echo e(asset('user_images/'.$feedbackBy->feedbackTo_users->user_image)); ?>);}else{ -->
...
<?php echo $__env->make('include.script', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\drolmaa\resources\views/expert_panel/feedback.blade.php ENDPATH**/ ?>