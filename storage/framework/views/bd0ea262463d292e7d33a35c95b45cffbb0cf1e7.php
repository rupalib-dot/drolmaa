    ...
    <li class="data-sheet <?php echo e(Request::is('expert/dashboard*') ? 'active' : ''); ?>">
        ...
        <li class="nav-item sidebar-dropdown data-sheet <?php echo e(Request::is('expert/exptransaction*') ? 'active' : ''); ?>" >
            ...
            <ul class="list-unstyled flex-column pl-3 collapse" id="submenu1" aria-expanded="false">
              ...
              <!-- <li class="nav-item" style="padding: 0px 0px;border: none;"><a class="nav-link" href="<?php echo e(route('exptransaction.index',['type'=>'order'])); ?>">Order</a></li> -->
              <!-- <li class="nav-item" style="padding: 0px 0px;border: none;"><a class="nav-link" href="<?php echo e(route('exptransaction.index',['type'=>'booking'])); ?>">Workshop</a></li> -->
...
<?php /**PATH C:\xampp\htdocs\drolmaa\resources\views/include/expert_sidebar.blade.php ENDPATH**/ ?>