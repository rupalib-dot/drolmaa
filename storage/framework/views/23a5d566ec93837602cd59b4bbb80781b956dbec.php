                    ...
                    <div class="row">
                        ...
                        <div class="col-md-10">
                            <div class="dashboard-panel">
                                ...
                                <a href="<?php echo e(route('expappointment.index',['type'=>'current'])); ?>"> <button class="<?php if(!isset($request['type']) || $request['type'] == 'current'): ?> curent-appoint <?php else: ?> previous-appoint <?php endif; ?>">Current Appointment</button></a>
...
</script><?php /**PATH J:\xampp\htdocs\drolmaa\resources\views/expert_panel/appointment.blade.php ENDPATH**/ ?>