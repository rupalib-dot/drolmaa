                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <div class="dashboard-panel">
                                ...
                                <a href="<?php echo e(route('appointment.index',['type'=>'current'])); ?>"> <button class="<?php if(!isset($request['type']) || $request['type'] == 'current'): ?> curent-appoint <?php else: ?> previous-appoint <?php endif; ?>">Current Appointment</button></a>
                                ...
                                <form action="<?php echo e(route('appointment.index')); ?>" class="form-appoint">
                                    ...
                                    <input style="margin-right: 5px !important;" type="date" name="to_date" value="<?php echo e(old('to_date',$request['to_date'])); ?>" class="mr-2">
...
<?php echo $__env->make('include.modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
  ...
  <?php /**PATH J:\xampp\htdocs\drolmaa\resources\views/customer_panel/appointment.blade.php ENDPATH**/ ?>