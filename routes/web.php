...
Route::group(['middleware' => ['administrator']], function(){
    Route::group(['prefix' => 'expert','middleware' => ['expert']], function() {
        ...
        Route::post('give-availability-note', [AvailabiltyController::class, 'add_note'])->name('expavailabiltyNote');
        Route::get('delete-availability/{id}', [AvailabiltyController::class, 'destroy'])->name('deleteAvailability');
    ...
    Route::group(['prefix' => 'admin','middleware' => ['admin']], function() { 
        ...
        //email subscribe
        Route::get('subscribe-email', [AdminController::class, 'EmailSubscribeEnquery'])->name('subscribe-email.list');
...
Route::get('allServices', [PagesController::class, 'services'])->name('page.services');
...
Route::post('subscribe-email', [PagesController::class, 'subscribeEmail'])->name('subscribe-email'); 
...
Route::namespace('CommonController')->group(function () {
    ...
    Route::get('verify_profile', [CommonTaskController::class, 'verifyProfile'])->name('verify.Profile');
    ...
    Route::post('amount', [AjaxController::class, 'plan_amount'])->name('plan.amount.ajax'); 
