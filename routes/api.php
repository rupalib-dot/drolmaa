...
Route::get('cancelReasons', [CommonController::class, 'cancelReasons']);
...
Route::post('my_feedback/{user_id}', [HomeController::class, 'feedbackList']);

// WORKSHOP API 
Route::post('workshop_index/{userid}', [workshopController::class, 'index']);
Route::post('store_workshop', [workshopController::class, 'store']);
Route::post('show_workshop/{workshopid}', [workshopController::class, 'show']);
...
Route::post('live_workshops/{userid}', [workshopController::class, 'liveWorkshops']);
...
//contact api
Route::post('contact', [CommonController::class, 'contact_us']);

Route::post('test', [CommonController::class, 'test']);
