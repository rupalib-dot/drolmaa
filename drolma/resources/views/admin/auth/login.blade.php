                        ...
                        <form class="text-left" id="login" method="POST" action="{{route('login.account')}}">
                            ...
                            <div class="form">
                                <div id="username-field" class="field-wrapper input">
                                    ...
                                    <input name="email_address" type="text" class="form-control" placeholder="Email Address" value="{{old('email_address')}}" required onkeypress="return LenCheck(event, this.value, '50')">
                                </div>
                                ...
                                <div id="password-field" class="field-wrapper input mb-2">
                                    ...
                                    <input id="password" name="user_password" type="password" class="form-control" placeholder="Password" value="{{old('user_password')}}" required onkeypress="return LenCheck(event, this.value, '16')">
