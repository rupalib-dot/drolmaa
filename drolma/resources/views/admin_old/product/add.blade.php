                                ...
                                <div class="row">    
                                    <div class="col-md-6">
                                        <div class="input-group mb-4">
                                            <input type="text" value="{{old('product_name')}}" name="product_name" class="form-control" placeholder="Product Name" aria-label="Product Name"
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group mb-4">
                                            <input type="date" min="{{date('Y-m-d')}}" class="form-control" value="{{old('expiry_date')}}" name="expiry_date" placeholder="Expiry Date"
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group mb-4">
                                            <input type="text" name="selling_price" id="selling_price" value="{{old('selling_price')}}" placeholder="Selling Price" class="form-control">
                                        </div>
                                    </div>  

                                    <div class="col-md-6">
                                        <div class="input-group mb-4">
                                            <input type="text" name="mrp" id="mrp" value="{{old('mrp')}}" placeholder="MRP" class="form-control">
                                        </div>
                                    </div>  

                                    <div class="col-md-6">
                                        <div class="input-group mb-4">
                                            <input type="number" name="quantity" id="quantity" value="{{old('quantity')}}" placeholder="Quantity" class="form-control">
                                        </div>
                                    </div>   
