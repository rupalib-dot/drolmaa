                            ...
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalCenterTitle">Talk to Our Expert</h5>
                ...
                <div class="col-sm-4">
                    ...
                    <div class="gallery-cell">
                        <div class="card border-0" style="width:18rem;">
                            <img src="{{asset('category/'.$categorys->category_image)}}"  width="232px" height="223px" class="card-img-top" alt="...">
                                    ...
                                    @foreach($testimonial as $testi)
                                        <div class="swiper-slide col-md-6">
                                            <div class="testimonialBox" style="background-image:url({{asset('front_end/images/quote.png')}})">
                                                ...
                                                <h5>{{ucfirst(strtolower($testi->person_name))}}</h5>
                                            </div>
                                        </div> 
                                    @endforeach
                                @endif
                            ...
                            foreach($blogcategory as $categorys){?> 
                                <div class="col-md-4">
                                    <a href="{{route('page.bloglist',$categorys->category_id)}}">
                                        <div class="blogImage">
                                            <div class="blogBox" style="background-image:url({{asset('category/'.$categorys->category_image)}});">
                                            </div>
                                            <div class="blogText"> 
...
@if(!empty($coupons))
    <section id="channel" class=" mt-5 channel" role="channel" >
        <!--  style="background-image:url({{asset('public/coupon/'.$coupons->coupon_image)}});" -->
        <div class="container">
            @if(!empty($coupons->coupon_image))
                <img src="{{asset('public/coupon/'.$coupons->coupon_image)}}" style="position: absolute; width: 100%; height: 98%;margin-left: -15px;">
            @endif
            <div class="row">
                <div class="col-md-4"> 
                    <div class="channelbox">
                        <h4 style="color: white;" class="sub btn btn-danger">{{$coupons->title}}</h4>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="channelbox">
                        <p style="color: white;">Sale Up To</p>
                        <h2><a class="offer sub btn btn-danger" style="color: white;">{{$coupons->discount}}% OFF</a></h2>
                    </div>
                </div>
                <div class="col-md-4 align-self-center text-center">
                    <div class="">
                        <!-- Button trigger modal -->
                        <button type="button" class="sub btn btn-danger">{{$coupons->coupon_code}}</button>
                        <!-- Modal -->
                        <div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
