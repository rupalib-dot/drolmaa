                ...
                <div class="back1">
                    ...
                    <form action="{{route('expert.second.step.post')}}" method="POST" enctype='multipart/form-data' class="formLogIn">
                        ...
                        <div class="form-group">
                            <textarea class="form-control" name="description" placeholder="Describe About Yourself..." id="exampleFormControlTextarea1" rows="4">{{old('description', !empty($expert) ? $expert->description : '')}}</textarea>
                          </div>
                        <div class="special">
