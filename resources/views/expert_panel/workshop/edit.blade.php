                            ...
                            <div class="dashboard-panel" style="padding-top: 20px;">
                                ...
                                <form action="{{route('expworkshop.update',$workshop->workshop_id)}}" method="POST" class="formLogIn" enctype='multipart/form-data'>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="input-group mb-4">
                                                <textarea type="text" maxlength="255" name="description" id="description" placeholder="Description" class="form-control">{{old('description',$workshop->description)}}</textarea>
                                            </div>
                                        </div> 
