                        ...
                        <div class="mt-3">
                            ...
                            <div class="row layout-top-spacing" style="margin-top:40px"> 
                                    ...
                                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                                        <a href="{{url('expert/profile')}}/{{Session::get('user_id')}}/edit">
                                    ...
                                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                                        <a  href="{{route('expert.transactions')}}">
                                             <div class="widget widget-one_hybrid widget-followers" style="height: 95%;">
                                                <div class="widget-heading">
                                        ...
                                        <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                                            <a href="{{route('expappointment.index')}}">
                                                <div class="widget widget-one_hybrid widget-followers" style="height: 95%;">
                                                    <div class="widget-heading">
                                ...
                                <div class="row layout-top-spacing" style="margin-top:40px">
                                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                                        <a href="{{route('availabilty.index')}}">
                                            <div class="widget widget-one_hybrid widget-followers" style="height: 95%;">
                                                <div class="widget-heading">
