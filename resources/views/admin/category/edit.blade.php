                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-6 col-md-12 col-sm-12 col-12">
                                    <div class="form-group mb-4">
                                        ...
                                        <img style="width: 250px; height: 200px; margin-top: 20px;" src="<?php if(empty($category->category_image)){?>{{asset('storage/category/'.$category->category_image)}}<?php }else{?>{{asset('front_end/images/blogimg.jpg')}}<?php }?>">
                                    </div>
                                </div>  
                            </div> 
