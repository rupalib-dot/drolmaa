            ...
            <div id="ftFormArray" class="col-lg-12 layout-spacing">
                ...
                <div class="statbox widget box box-shadow">
                    ...
                    <div class="widget-content widget-content-area custom-autocomplete h-100"> 
                        <form action="{{route('category.store')}}" method="POST" class="formLogIn" enctype='multipart/form-data'>
                            @csrf  
                            <div class="row">
                                <div class="col-xl-6 col-md-12 col-sm-12 col-12">
                                    <div class="form-group mb-4">
                                        <label for="mobile">Category Name</label>
                                        <input type="text" value="{{old('category_name')}}" name="category_name" class="form-control" placeholder="Category Name" aria-label="Category Name" aria-describedby="basic-addon1">
                                    </div>  
                                </div>   
                                <div class="col-xl-6 col-md-12 col-sm-12 col-12">
                                    <div class="form-group mb-4">
