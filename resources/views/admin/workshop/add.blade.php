                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-6 col-md-12 col-sm-12 col-12">
                                    <div class="form-group mb-4">
                                        ...
                                        <input type="date" min="{{date('Y-m-d')}}" class="form-control" value="{{old('date')}}" name="date" placeholder="Workshop Date" aria-label="Date of Birth" aria-describedby="basic-addon1">
                                    </div> 
                                </div>
                            </div> 
                            <div class="row">
