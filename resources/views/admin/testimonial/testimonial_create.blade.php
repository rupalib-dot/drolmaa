                            ...
                            <div class="row">
                                <div class="form-group col-6 custom-file-container">
                                    ...
                                    <div class="widget-content widget-content-area p-0">
                                        <textarea id="product_details" maxlength="1000" name="testimonial_detail">{{ old('testimonial_detail', isset($record_data) ? $record_data->testimonial_detail : '') }}</textarea>
                                    </div>
                                </div>
                                <div class="form-group col-6 custom-file-container">
                                    ...
                                    @if(isset($record_data) && !empty($record_data->person_photo))
                                        <img class="images-box-r" src="{{asset('public/testimonial')}}/{{$record_data->person_photo}}" width="400" style="padding-top:10px;"/>
                                    @endif
                                </div>
                            </div>
