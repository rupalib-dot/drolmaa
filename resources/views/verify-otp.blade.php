        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="formRight">
                    ...
                    <form action="{{route('verify.otp.submit',['module'=>$module,'page'=>$page,'user_id'=>base64_encode($user_id),'otp'=>base64_encode($otp)])}}" class="formLogIn" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-md-12">
                                <div class="input-group mb-4">
                                    <input type="text" class="form-control" placeholder="OTP" aria-label="OTP" aria-describedby="basic-addon1" name="otp_input" value="{{old('otp_input')}}">
                                </div> 
                            </div> 
                            <div class="col-md-12">
                                <div class="input-group mb-4">
