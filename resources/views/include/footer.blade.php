                    ...
                    <div class="footerBox">
                        ...
                        <form action="{{route('subscribe-email')}}" method="post">
                            ...
                            <div class="input-group mb-3">
                                <input type="text" name="email" value="{{old('email')}}" required placeholder="Enter Email Address" class="form-control" aria-label="Email">
                                <div class="input-group-append">
                                    <span class="">
                                    <button type="submit" class="bg-light border-0" style="padding: .31rem .75rem;"><img src="{{asset('front_end/images/button_search_1.svg')}}" class="mb-0" alt="" srcset=""> </button>
                                    </span>
                                </div>
                            </div>
                        </form>
