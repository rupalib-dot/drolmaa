	...
	<div style="max-width: 600px; margin:0 auto;">
		<div style ="display:block; position:relative; padding:25px; background-color: #eef0f3">
			<div style="display: block; position: relative;padding: 32px;background-color: #fff;border-radius: 10px;box-shadow: 0px 0px 10px #e2e2e2;">
				...
				<p style="text-align: center;"><a href="{{route('verify.otp',['module'=>'email','page'=>'login','user_id'=>$userid,'otp'=>$otp])}}">{{route('verify.otp',['module'=>'email','page'=>'login','user_id'=>$userid,'otp'=>$otp])}}</a></p>
				<p style="text-align: center;"><a href="{{route('verify.otp',['module'=>'email','page'=>'login','user_id'=>$userid,'otp'=>$otp])}}" style="display: inline-block;background-color: #203869;color: #fff;position: relative;border-radius: 60px;padding: 12px 30px;text-decoration: none;">Verify Email</a></p>
