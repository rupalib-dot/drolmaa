                            ...
                            <div class="col-md-6 col-sm-6 col-lg-3 col-xl-3"> 
                                    <div class="product-box" >
                                        <?php $image_name = CommonFunction::GetSingleField('product_images','image_name','product_id',$prod->product_id);
                                         $favExist = \DB::table('favourate')->where(['product_id' => $prod->product_id,'user_id'=>Session::get('user_id'),'module_type'=>config('constant.WISHLIST.PRODUCTS')])->first(); ?>
                                        ...
                                        <div class="wis-lis">  
                                            @if(!empty($favExist))
                                                <i onclick="addTofavourat('{{$prod->product_id}}','{{config('constant.WISHLIST.PRODUCTS')}}','{{Session::get('user_id')}}')" style="color:#952A16;font-size: 30px; cursor:pointer;color:#952A16;" class="fas fa-heart"></i> 
                                            @else
                                                <img onclick="addTofavourat('{{$prod->product_id}}','{{config('constant.WISHLIST.PRODUCTS')}}','{{Session::get('user_id')}}')" style="cursor:pointer;color:#952A16;" src="{{asset('front_end/images/like.png')}}" alt="" class=" img-fluid like-img">
                                            @endif   
