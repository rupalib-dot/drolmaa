                            ...
                            if(count($avail_slots) >0){
                                ...
                                <div class="card border-0  mb-3" style="max-width:100%;">
                                    <div class="row no-gutters">
                                        <div class="col-md-3">
                                        <img width="100%;" height="160px;" src="@if(!empty($expert->user_image)) {{asset('public/user_images/'.$expert->user_image)}} @else {{asset('front_end/images/blogimg.jpg')}} @endif" class="card-img" alt="...">
                                        ...
                                        <div class="col-md-8">
                                            <div class="card-body" style="padding-top:0px;">
                                                ...
                                                <div class="pl-0 col-lg-12 expert_button">
                                                    ...
                                                    <a style="text-align:center; margin-left: 60%;margin-top: 15px;" href="{{route('appointment.create',['designation_id'=>$expert->designation_id,'user_id'=>$expert->user_id])}}">Book Appointment</a>
                                                    @endif
                                                </div> 
                                            </div>
                                        </div>
