...
class PagesController extends Controller
{
    ...
    public function subscribeEmail(Request $request){
            ...
            $validatedData = $request->validate([
             ...
             $count_row = SubscribeEmail::create($data);  
            if(!empty($count_row)){
                return redirect()->back()->with('Success', 'Email subscription submitted successfully');
            }else{
    ...
    { 
        ...
        $subscription_data    = Subscription::where('user_id',Session::get('user_id'))->orderBy('subscription_id','desc')->first();
       $title          = "Pricing"; 
        $data           = compact('title','record_data','subscription_data');
    ...
    public function shopDetail(Request $request,$id)
    {
       ...
       $similarProducts = Products::where('category_id',$product->category_id)->where('product_id','!=',$product->product_id)->get();
        $data           = compact('title','product','similarProducts','id');
