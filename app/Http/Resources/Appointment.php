...
class Appointment extends JsonResource
{
    ...
    { 
        ...
        $feedback_data      = new FeedbackArtical(Feedback::where('feedback_by',$this->user_id)->where('module_id',$this->appointment_id)->where('module_type',config('constant.FEEDBACK.APPOINMENT'))->first());
